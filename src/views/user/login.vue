<template>
  ...
  <el-form :label-position="labelPosition" :model="loginForm" status-icon :rules="rules" ref="loginForm"
    label-width="100px">
    <el-form-item label="用户名" prop="login">
      <el-input v-model.number="loginForm.login" placeholder="请输入用户名"></el-input>
    </el-form-item>
