<template>
  <div>
    <el-row>
      <el-col :span="6" class="grid-content bg-purple-dark title"
        >注册请求</el-col
      ></el-row
    >
    ...
    <el-dialog title="用户详细信息" v-model="dialogVisible" width="70%">
      <el-descriptions
        class="margin-top"
        title="用户基本信息"
        :column="2"
      ...
      >
        ...
        <el-descriptions-item label="煤炭经营许可证编号">{{
          detailform.manageLicenseId
        }}</el-descriptions-item>
        <el-descriptions-item label="煤炭经营许可证文件">
          <el-upload
            ...
            action=""
            @click="
              downloadpic(detailform.userId, detailform.manageLicenseFile, 0)
            "
          >
          </el-upload>
        </el-descriptions-item>
        <el-descriptions-item label="企业营业执照号">{{
          detailform.businessLicenseId
        }}</el-descriptions-item>
        <el-descriptions-item label="企业营业执照文件">
          <el-upload
            ...
            action=""
            @click="
              downloadpic(detailform.userId, detailform.businessLicenseFile, 0)
            "
          >
          </el-upload>
        </el-descriptions-item>
        ...
        <el-descriptions-item label="税务登记证代码">{{
          detailform.trCert
        }}</el-descriptions-item>
      ...
      <template #footer>
        <span class="dialog-footer">
          <el-button type="danger" @click="notpass(detailform.userId)"
            >拒绝</el-button
          >
          <el-button type="success" @click="pass(detailform.userId)"
            >通过</el-button
          >
        </span>
      </template>
